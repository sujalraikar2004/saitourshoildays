...
export const AirlineTicketing = () => {
  ...
  const sendEmail = async(e) => {
    ...
    try {
      await axios.post("https://backend-nine-mauve-86.vercel.app/airline_booking", templateParams);
  ...
  return (
    <Layout>
      ...
      {/* Services Section */}
      <h2 className="text-4xl font-bold text-gray-800 mb-10 text-center translate-y-8 transition-all duration-500 delay-300">
  Our Services
</h2>
